...
class ConversationEngine {
  ...
  constructor(appName) {
    ...
    this.launchPhrases = ['Yes. How can I help?', 'Hey. Need me?', 'Yup. I am here.'];
    this.closeRequests = ['I am good', 'No I am good', 'Thanks', 'Thank you'];
