...
FlowScriptCompiler.registerNonNestableWidgetImpl('say', (response, flowScriptDoc, elNode)=>{
  ...
  if (elNode.attrib('endConversation')) response.endConversation();
  if (elNode.attrib('keepConversationRunning')) response.keepConversationRunning();
});
...
FlowScriptCompiler.registerWidgetHook('app', (flowScriptDoc, convoEngine, node)=>{
  var respondArr = FlowScriptCompiler.choiceHooksForRegistering(flowScriptDoc, convoEngine, null, node);
...
FlowScriptCompiler.registerWidgetHook('decision', (flowScriptDoc, convoEngine, decisionNode)=>{
  ...
  goalObj.respondTo = FlowScriptCompiler.choiceHooksForRegistering(flowScriptDoc, convoEngine, decisionNode.id(), decisionNode);
