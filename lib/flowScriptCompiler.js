...
class FlowScriptCompiler {
   ...
   * @param {String} widgetDef.init - initiatlizes the widget for every element
   *   in the CFL document. This parameter method is used rarely (by *app*,
   ...
   *   *registeringIntentHooks* method. The callback is called with three
   ...
   *   called after at runtime when the widget gets triggered. for example with
   *   say, prompt, etc
