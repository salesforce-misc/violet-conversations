...
class GooglePlatformReq extends PlatformReq {
  ...
  getUserId() {
    ...
    // deprecated - but official approach does not seem to work
    // console.log(`GooglePlatformReq.gActions.user.id: `, gActions.user.id);
    return gActions.user.id;

    // new approach - but it seems that we are always generating the id
    // var userId;
