...
//  - create instructions - in part based on README.md here: https://github.com/actions-on-google/dialogflow-number-genie-nodejs
    ...
    violetRouter.post('/', function (request, response) {
      try {
        ...
        request.getSession = () => {
          return {
            get: (varStr) => {
              console.log('Request to get session variable: ' + varStr);
              return sessionStore[varStr];
            },
            set: (varStr, val) => {
              console.log('Request to set session variable: ' + varStr + ' to: ' + val);
