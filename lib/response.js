...
module.exports = class Response {
  ...
  contains(varStr) {
    ...
    var matchResult = this.__matchAgainstStore(varStr, paramsRE);
    if (matchResult.matched) return this.__containsUsingMatched(matchResult, this.sessionStore);
  ...
  get(varStr) {
    ...
    var matchResult = this.__matchAgainstStore(varStr, paramsRE);
    if (matchResult.matched) return this.__getUsingMatched(matchResult, this.sessionStore);
