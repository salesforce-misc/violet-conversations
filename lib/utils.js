 ...
 * @module violet-conversations/utils
 */
 ...
 */
exports.loadArrayFromFile =  function(fileName) {
  return fs.readFileSync(path.join(path.dirname(module.parent.filename), fileName), 'utf8')
      .split('\n')
