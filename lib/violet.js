  ...
  var __getResponse = (requ, resp) => {
    ...
    var response = {
      ...
      load: (objName, keyName, keyVal, filter, queryXtra) => {
        ...
        var keyNameMatch = storeRE.exec(keyName);
        if (keyNameMatch != null) keyName = keyNameMatch[1];
        ...
        if (keyName != null) {
          console.log('Loading object: ' + objName);
          return persistentStore.load(objName, keyName, keyVal, filter, queryXtra);
        } else if (filter != null) {
          console.log('Loading object: ' + objName);
          return persistentStore.load(objName, null, null, filter, queryXtra);
        }
