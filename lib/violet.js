...
module.exports = function(app) {
  ...
  var _registerGlobalIntents = () => {
    ...
    for (var phrase in globalIntents) {
      var phraseOptions = globalIntents[phrase];
      var intentParams = {};
      var userSpeech = [phrase];
      ...
      app.intent(_genIntentName(), intentParams, (requ, resp) => {
        ...
        console.log('No matching response for:', intentParams["utterances"]);
      });
