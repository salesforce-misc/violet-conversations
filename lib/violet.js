...
module.exports = function(app) {
  ...
  var _say = function(response, potResponses) {
    ...
    if (response) { // unlikely, but in error situations response can be null
      str = getParamValuesFromStore(str, paramsGRE, response._paramsStore());
      str = getParamValuesFromStore(str, sessionGRE, response._sessionStore());
      str = getParamValuesFromStore(str, storeGRE, response._persistentStore());
    }
