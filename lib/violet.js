...
module.exports.script = function() {
  ...
  violet.respondTo({name: 'closeSession2', expecting: ["I am good", "No I am good", "Thanks", "Thank you"], resolve: (response) => { response.endConversation(); }});
  return violet;
};
