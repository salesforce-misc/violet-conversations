...
var sfStore = {
  ...
  memory: {}, // <-- Deprecated - this would have allowed us to implement 3-way data binding, but lets get the basics ala Angular1 working
  _objProps: (params)=>{
    var objProps = sfStore.defaultPropOfInterest;
  ...
  load:  (params)=>{
    ...
    return org.query({ query: q }).then(function(resp){
      ...
      if (!params.objName || !params.propOfInterest) {
